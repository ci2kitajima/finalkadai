...
class OrdersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'orders_ibfk_1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'user_id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'user_id' => 1,
            'payment' => 1,
            'order_date' => '2017-03-09 13:10:41',
            'created' => '2017-03-09 13:10:41',
            'modified' => '2017-03-09 13:10:41',
